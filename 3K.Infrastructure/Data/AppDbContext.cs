    ...
    public class AppDbContext : DbContext
    {
        ...
        private static void SeedRbacData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MenuTanimi>().HasData(
                ...
                new MenuTanimi { Id = 42, Kod = "saha-gerceklesen-ceki-raporu", LabelKey = "MENU.SAHA_GERCEKLESEN_CEKI_RAPORU", Icon = "", Route = null, Sira = 9, ParentId = 17 },
                new MenuTanimi { Id = 40, Kod = "sahaya-aktar", LabelKey = "MENU.SAHAYA_AKTAR", Icon = "", Route = null, Sira = 10, ParentId = 17 },
                new MenuTanimi { Id = 41, Kod = "saha-aktarim-geri-al", LabelKey = "MENU.SAHA_AKTARIM_GERI_AL", Icon = "", Route = null, Sira = 11, ParentId = 17 },
