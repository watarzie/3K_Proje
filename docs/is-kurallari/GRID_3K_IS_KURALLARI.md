...
- **K-053 — Revizyonda plan/fiili sandık ayrımı korunur.** Fiili sandık eski planı izliyorsa yeni plana güncellenir; özel fiili konum ezilmez. İçerik taşıma için plan değişikliği, fiili-plan eşliği ve taşınabilir içerik koşulları birlikte aranır.
  Plan değişmemişse de, plan/fiili aynı hedefi gösterirken aynı projedeki tek tam/legacy tahsis başka sandığa bağlı kalmışsa bu bağlantı revizyonla düzeltilebilir. Çoklu/kısmi tahsis ve özel fiili konum bu ek düzeltmeye alınmaz; kaynak ve hedef sevk kilitleri aşılamaz. Önizlemede gerçek tahsis sandığının değişimi ve kaynak sandık etkisi gösterilir, onay bütünlüğüne dahil edilir.
  Taşınabilirlik sevk kilidinin olmaması ve konulan/eksik/kaynak paylarının sıfır olmasıdır; revizyonun kendi eksik hesabından önce değerlendirilir. U otomatik geri alması bu alanları önce temizleyebildiği için önizleme uyarısı ile son hareket sırası birlikte okunmalıdır.
