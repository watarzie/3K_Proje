...
{
    /// <summary>
    /// Tekil ve toplu taşımanın aynı tahsis/fiziksel hareket kuralları.
    /// Transaction sınırını çağıran handler yönetir; başarısız sonuç commit edilmemelidir.
    /// </summary>
    internal sealed class SandikUrunTasimaIslemi
    {
        private const decimal EnYuksekTasinabilirMiktar = 99999999999999.9999m;
        private readonly IUnitOfWork _unitOfWork;
        private readonly ISahaTamamlamaService _sahaTamamlamaService;

        public SandikUrunTasimaIslemi(IUnitOfWork unitOfWork, ISahaTamamlamaService sahaTamamlamaService)
        {
            _unitOfWork = unitOfWork;
            _sahaTamamlamaService = sahaTamamlamaService;
        }

        public async Task<Result> TasiAsync(SandikUrunTasiCommand request, int kullaniciId, CancellationToken cancellationToken)
        {
        ...
        internal static bool MiktarHassasiyetiGecerliMi(decimal miktar)
        {
        ...
        internal static bool TransferTekrariAyniMi(SandikUrunTransferi transfer, SandikUrunTasiCommand request)
        {
        ...
        internal static async Task<Result?> KayitliTransferTekrariniDogrulaAsync(
